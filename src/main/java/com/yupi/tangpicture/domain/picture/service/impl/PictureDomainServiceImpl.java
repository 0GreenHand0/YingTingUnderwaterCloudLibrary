package com.yupi.tangpicture.domain.picture.service.impl;
...
import com.yupi.tangpicture.domain.picture.service.PictureDomainService;
...
import com.yupi.tangpicture.infrastructure.api.CosManager;
import com.yupi.tangpicture.infrastructure.api.aliyunai.AliYunAiApi;
import com.yupi.tangpicture.infrastructure.api.aliyunai.model.CreateOutPaintingTaskRequest;
...
import com.yupi.tangpicture.infrastructure.utils.ColorSimilarUtils;
import com.yupi.tangpicture.interfaces.dto.picture.*;
import com.yupi.tangpicture.interfaces.vo.picture.PictureVO;
import com.yupi.tangpicture.infrastructure.manager.upload.FilePictureUpload;
import com.yupi.tangpicture.infrastructure.manager.upload.PictureUploadTemplate;
import com.yupi.tangpicture.infrastructure.manager.upload.UrlPictureUpload;
import com.yupi.tangpicture.infrastructure.manager.upload.UploadPictureResult;
...
//            }
            //校验空间是否一致
            //没传spaceId，则服用原有图片的spaceId(这样也兼容了公共图库）
            if(spaceId==null){
    ...
    public Integer uploadPictureByBatch(PictureUploadByBatchRequest pictureUploadByBatchRequest, User loginUser) {
        ...
        for (Element imgElement : imgElementList) {
            ...
            // 处理图片上传地址，防止出现转义问题
            //比如 codefather.cn?yupi=dog，应该只保留codefather.cn
