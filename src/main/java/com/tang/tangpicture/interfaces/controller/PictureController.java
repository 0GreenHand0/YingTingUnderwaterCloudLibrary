package com.tang.tangpicture.interfaces.controller;
...
import com.tang.tangpicture.infrastructure.api.aliyunai.AliYunAiApi;
import com.tang.tangpicture.infrastructure.api.aliyunai.model.CreateOutPaintingTaskResponse;
import com.tang.tangpicture.infrastructure.api.aliyunai.model.GetOutPaintingTaskResponse;
import com.tang.tangpicture.infrastructure.api.imagesearch.ImageSearchApiFacade;
import com.tang.tangpicture.infrastructure.api.imagesearch.model.ImageSearchResult;
import com.tang.tangpicture.infrastructure.common.BaseResponse;
import com.tang.tangpicture.infrastructure.common.DeleteRequest;
import com.tang.tangpicture.infrastructure.common.ResultUtils;
import com.tang.tangpicture.domain.user.constant.UserConstant;
...
import com.tang.tangpicture.infrastructure.exception.ThrowUtils;
import com.tang.tangpicture.interfaces.dto.picture.*;
import com.tang.tangpicture.shared.auth.SpaceUserAuthManager;
import com.tang.tangpicture.shared.auth.StpKit;
import com.tang.tangpicture.shared.auth.annotation.SaSpaceCheckPermission;
import com.tang.tangpicture.shared.auth.model.SpaceUserPermissionConstant;
...
import com.tang.tangpicture.domain.picture.valueobject.PictureReviewStatusEnum;
import com.tang.tangpicture.interfaces.vo.picture.PictureTagCategory;
import com.tang.tangpicture.interfaces.vo.picture.PictureVO;
import com.tang.tangpicture.application.service.PictureApplicationService;
import com.tang.tangpicture.application.service.SpaceApplicationService;
...
// 从本地缓存中查询
    ...
    public BaseResponse<PictureTagCategory> listPictureTagCategory() {
        ...
        List<String> tagList = Arrays.asList("亮光", "暗光", "鱼", "海底", "珊瑚", "海星", "海龟", "背景", "地面");
        List<String> categoryList = Arrays.asList("高清", "清晰", "模糊","偏蓝","偏绿","偏黄");
    ...
    public BaseResponse<List<ImageSearchResult>> searchPictureByPicture(@RequestBody SearchPictureByPictureRequest searchPictureByPictureRequest) {
        ...
        ThrowUtils.throwIf(oldPicture == null, ErrorCode.NOT_FOUND_ERROR);
        //webp格式不能搜索，调用cos云存储本身自带的方法转换为其他格式
