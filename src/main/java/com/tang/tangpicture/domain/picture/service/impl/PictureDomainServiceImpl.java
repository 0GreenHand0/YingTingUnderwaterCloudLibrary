package com.tang.tangpicture.domain.picture.service.impl;
...
import com.tang.tangpicture.domain.picture.service.PictureDomainService;
...
import com.tang.tangpicture.infrastructure.api.CosManager;
import com.tang.tangpicture.infrastructure.api.aliyunai.AliYunAiApi;
import com.tang.tangpicture.infrastructure.api.aliyunai.model.CreateOutPaintingTaskRequest;
...
import com.tang.tangpicture.infrastructure.utils.ColorSimilarUtils;
import com.tang.tangpicture.interfaces.dto.picture.*;
import com.tang.tangpicture.interfaces.vo.picture.PictureVO;
import com.tang.tangpicture.infrastructure.manager.upload.FilePictureUpload;
import com.tang.tangpicture.infrastructure.manager.upload.PictureUploadTemplate;
import com.tang.tangpicture.infrastructure.manager.upload.UrlPictureUpload;
import com.tang.tangpicture.infrastructure.manager.upload.UploadPictureResult;
...
//            }
    ...
    public Integer uploadPictureByBatch(PictureUploadByBatchRequest pictureUploadByBatchRequest, User loginUser) {
        ...
        for (Element imgElement : imgElementList) {
            ...
            // 处理图片上传地址，防止出现转义问题
            //比如 codefather.cn?tang=dog，应该只保留codefather.cn
