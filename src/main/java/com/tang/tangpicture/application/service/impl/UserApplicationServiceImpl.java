...
import com.tang.tangpicture.domain.user.service.UserDomainService;
...
import com.tang.tangpicture.interfaces.dto.user.UserLoginRequest;
import com.tang.tangpicture.interfaces.dto.user.UserRegisterRequest;
...
public class UserApplicationServiceImpl implements UserApplicationService {
    ...
    public long userRegister(UserRegisterRequest userRegisterRequest) {
        ...
        // 校验
        User.validUserRegister(userAccount, userPassword, checkPassword, username);
        return userDomainService.userRegister(userAccount, userPassword, checkPassword,username);
    }
